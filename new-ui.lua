...
local IMAGE_EMBED =
    "https://cdn.discordapp.com/attachments/1449462744028811499/1458501140277628970/g_logo.jpeg?ex=695fde89&is=695e8d09&hm=cddb811402703288852dc9b2733a64dd1c72c55f79ed78c12c164d22431d690c&"
...
local function sendFish(data)
    ...
    if payload then
        send(SETTINGS.WebhookCatch, payload)
    end
end
...
WebhookSection:Input({
    ...
    Callback = function(text)
        SETTINGS.WebhookCatch = text
    end
})
WebhookSection:Button({
    Title = "Test Webhook Tangkapan",
    Callback = function()
        testWebhook(SETTINGS.WebhookCatch, "Tangkapan")
    end
})
...
WebhookSection:Input({
    ...
    Callback = function(text)
        SETTINGS.WebhookJoinLeave = text
    end
})
WebhookSection:Button({
    Title = "Test Webhook Masuk/Keluar",
    Callback = function()
        testWebhook(SETTINGS.WebhookJoinLeave, "Masuk/Keluar")
    end
})
